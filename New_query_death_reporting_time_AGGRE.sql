...
SELECT 
Deaths.DaysFromDiscoveryToNotifyGroup
	, COUNT(Deaths.DaysFromDiscoveryToNotifyGroup) AS Frequency
...
--WHERE Deaths.RowNum = 1

GROUP BY Deaths.DaysFromDiscoveryToNotifyGroup
